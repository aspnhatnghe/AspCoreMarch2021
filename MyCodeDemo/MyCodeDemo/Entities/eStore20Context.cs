...
namespace MyCodeDemo.Entities
{
    public partial class eStore20Context : DbContext
    {
        ...
        public virtual DbSet<UserHasIndex> UserHasIndex { get; set; }
        public virtual DbSet<UserNonIndex> UserNonIndex { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserHasIndex>(entity =>
            {
            ...
            modelBuilder.Entity<UserNonIndex>(entity =>
            {
                entity.HasNoKey();
